...
# relevant for spectrumrange method.
audio_duration = 16         # length of the analyzed segment in seconds.
test_frame = 0.5        # in seconds
test_interval = 0.25    # in seconds

# relevant for spectrum keys method
sampling_rate = 1024        # samples per second.
key_threshold = 0.45         # threshold of a key to be recognized.

key_strokes = 16            # number of potential simultaneouskey strokes. 
key_max_duration = (0.5, 8) # min and max duration of key strokes.
key_interval = 0.5          # intervals at which keys are pressed.
...
def spectrumRangeToKeys(spectrum): 
    ...
    while s < audio_duration - test_frame: 
        ...
        de = math.floor(e * sampling_rate) - 1
